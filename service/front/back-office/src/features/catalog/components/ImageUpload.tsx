...
import { useUploadServiceImagesMultipart } from '../hooks/useServices';
import type { UploadedImage } from '../types/service.types';
...
export function ImageUpload({
  ...
  const uploadMutation = useUploadServiceImagesMultipart();
