...
Write-Host "[1/4] Arret et suppression des conteneurs et volumes..." -ForegroundColor Yellow
try {
...
Write-Host "[2/4] Suppression des images Docker CYNA..." -ForegroundColor Yellow
try {
...
Write-Host "[3/4] Nettoyage des ressources Docker orphelines..." -ForegroundColor Yellow
try {
...
Write-Host "[4/4] Reconstruction et demarrage de la stack..." -ForegroundColor Yellow
